      ...
      <br><br>
		...
		<privacy>
			...
			<center><h3>WHY</h3></center>
				...
				following the user's prior consent.<br>
			...
			<center><h3>TO WHOM</h3></center>
				Personal data categories A and B are published on the site in the form of an open database, which is publicly available and downloadable by any visitor of the site. Personal data processed on this site is not shared in any other form, especially with third parties.<br>
			<center><h3>CONTROL</h3></center>
				...
				The above requests should be submitted through the indicated contact details of the administrator.
		</privacy>
